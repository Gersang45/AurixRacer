...
boolean AppShell_condition(pchar args, void *data, IfxStdIf_DPipe *io);
boolean AppShell_StateTrack(pchar args, void *data, IfxStdIf_DPipe *io);
boolean AppShell_Pgain(pchar args, void *data, IfxStdIf_DPipe *io);
boolean AppShell_Dgain(pchar args, void *data, IfxStdIf_DPipe *io);
...
boolean AppShell_radarscan0(pchar args, void *data, IfxStdIf_DPipe *io);
boolean AppShell_monlinescan(pchar args, void *data, IfxStdIf_DPipe *io);
boolean AppShell_monlinescan1(pchar args, void *data, IfxStdIf_DPipe *io);
...
const Ifx_Shell_Command AppShell_commands[] = {
    {"status", "   : Show the application status", &g_AsclinShellInterface,       &AppShell_status,    },
    {"condition", ": Show the car status", &g_AsclinShellInterface,       &AppShell_condition,    },
    {"track", "    : Change track state", &g_AsclinShellInterface,       &AppShell_StateTrack,    },
	{"pg", "       : Steer P gain", &g_AsclinShellInterface,       &AppShell_Pgain,    },
	{"dg", "       : Steer D gain", &g_AsclinShellInterface,       &AppShell_Dgain,    },
    {"m0v", "      : Motor0Vol_Ref", &g_AsclinShellInterface,       &AppShell_motor0vol,    },
    {"m1v", "      : Motor0Vol", &g_AsclinShellInterface,       &AppShell_motor1vol,    },
    {"m0e", "      : Motor0Enable", &g_AsclinShellInterface,       &AppShell_motor0en,    },
    {"srv", "      : Servo Angle", &g_AsclinShellInterface,       &AppShell_srv,    },
...
//    {"l2", "       : LED2", &g_AsclinShellInterface,       &AppShell_led2,    },
    {"ls0", "      : LineScan0", &g_AsclinShellInterface,       &AppShell_linescan0,    },
    {"ls1", "      : LineScan1", &g_AsclinShellInterface,       &AppShell_linescan1,    },
	{"rs0", "      : RadarScan0", &g_AsclinShellInterface,       &AppShell_radarscan0,    },
    {"mls", "      : Monitoring LineScan", &g_AsclinShellInterface,       &AppShell_monlinescan,    },
    {"mls1", "      : Monitoring LineScan", &g_AsclinShellInterface,       &AppShell_monlinescan1,    },
//    {"vadc", "     : Vadc Backgound 1", &g_AsclinShellInterface,       &AppShell_vadcbg1,    },
//    {"enc", "      : Encoder", &g_AsclinShellInterface,       &AppShell_enc,    },
//    {"p00_0", "    : Port00_0", &g_AsclinShellInterface,       &AppShell_port00_0,    },
//    {"p00_1", "    : Port00_1", &g_AsclinShellInterface,       &AppShell_port00_1,    },
...
#elif BOARD == SHIELD_BUDDY
	AppShell_condition(0, NULL_PTR, &g_AsclinShellInterface.stdIf.asc );
	AppShell_StateTrack(0, NULL_PTR, &g_AsclinShellInterface.stdIf.asc );
	AppShell_Pgain(0, NULL_PTR, &g_AsclinShellInterface.stdIf.asc );
	AppShell_Dgain(0, NULL_PTR, &g_AsclinShellInterface.stdIf.asc );
	AppShell_motor0vol(0, NULL_PTR, &g_AsclinShellInterface.stdIf.asc );
	AppShell_motor1vol(0, NULL_PTR, &g_AsclinShellInterface.stdIf.asc );
	AppShell_motor0en(0, NULL_PTR, &g_AsclinShellInterface.stdIf.asc );
	AppShell_srv(0, NULL_PTR, &g_AsclinShellInterface.stdIf.asc );
...
boolean AppShell_condition(pchar args, void *data, IfxStdIf_DPipe *io)
{
    ...
    else
    {
    	...
    	IfxStdIf_DPipe_print(io, "  State_Scan      : %2d "ENDL, State_Scan);
    	IfxStdIf_DPipe_print(io, "  State_Track     : %2d "ENDL ENDL, State_Track);
    	IfxStdIf_DPipe_print(io, "  Line_Left       : %3d "ENDL, Line_Left);
    	IfxStdIf_DPipe_print(io, "  Line_Right      : %3d "ENDL, Line_Right);
    	IfxStdIf_DPipe_print(io, "  Dash line       : %3d "ENDL, Pos_DL);
    	IfxStdIf_DPipe_print(io, "  Offset          : %3d "ENDL ENDL, Offset);
    	IfxStdIf_DPipe_print(io, "  Steer Duty      : %6.4f "ENDL, IR_getSrvAngle());
    	IfxStdIf_DPipe_print(io, "  Steer Error     : %3d "ENDL ENDL, Error_Steer);
    	IfxStdIf_DPipe_print(io, "  Motor Duty_Ref  : %4.2f "ENDL, Duty_Motor);
    	IfxStdIf_DPipe_print(io, "  Motor Duty      : %4.2f "ENDL, IR_getMotor0Vol());
    	IfxStdIf_DPipe_print(io, "  Car Speed       : %5.3f "ENDL ENDL, Speed);
    	IfxStdIf_DPipe_print(io, "  P_Steer gain    : %f "ENDL, P_Steer);
    	IfxStdIf_DPipe_print(io, "  D_Steer gain    : %f "ENDL, D_Steer);
    }
...
boolean AppShell_StateTrack(pchar args, void *data, IfxStdIf_DPipe *io)
{
	...
	if (Ifx_Shell_matchToken(&args, "?") != FALSE)
    {
        IfxStdIf_DPipe_print(io, "  Syntax     : change state of track"ENDL);
    }
    else
    {
    	...
    	IfxStdIf_DPipe_print(io, "  State Track: %d fraction"ENDL, State_Track);
    }
...
boolean AppShell_Pgain(pchar args, void *data, IfxStdIf_DPipe *io)
{
    ...
    else
    {
    	...
    	IfxStdIf_DPipe_print(io, "  P_Steer gain: %f fraction"ENDL, P_Steer);
    }
...
boolean AppShell_Dgain(pchar args, void *data, IfxStdIf_DPipe *io)
{
    ...
    else
    {
    	...
    	IfxStdIf_DPipe_print(io, "  D_Steer gain : %f fraction"ENDL, D_Steer);
    }
...
boolean AppShell_motor0vol(pchar args, void *data, IfxStdIf_DPipe *io)
{
    ...
    else
    {
    	...
    	IfxStdIf_DPipe_print(io, "  Motor0Vol_Ref: %4.2f fraction"ENDL, Duty_Motor);
    }
...
boolean AppShell_srv(pchar args, void *data, IfxStdIf_DPipe *io)
{
    ...
    else
    {
    	...
    	IfxStdIf_DPipe_print(io, "  SrvAngle: %6.4f fraction"ENDL, IR_getSrvAngle());
    }
...
boolean AppShell_monlinescan1(pchar args, void *data, IfxStdIf_DPipe *io)
{
    ...
    else
    {
    	...
    	IfxStdIf_DPipe_print(io, "  mls: %4d "ENDL, g_Radar.period_ms);
    }
...
boolean AppShell_radarscan0(pchar args, void *data, IfxStdIf_DPipe *io){
	...
	if (Ifx_Shell_matchToken(&args, "?") != FALSE)
    {
        IfxStdIf_DPipe_print(io, "  Syntax     : rs0 "ENDL);
    }
    else
    {
    	if(Ifx_Shell_parseSInt32(&args, &period_ms) != FALSE){
    	...
    	IfxStdIf_DPipe_print(io, "  RadarScan0 results "ENDL);
    	for(i = 0; i<24; i++){
    		IfxStdIf_DPipe_print(io, "%3d,%4d/",i*15,IR_Radar[i]);
    	}
		IfxStdIf_DPipe_print(io, "%4d"ENDL,IR_Radar[i]);
    }
    return TRUE;
}
//
...
boolean AppShell_srvscan(pchar args, void *data, IfxStdIf_DPipe *io)
{
    ...
    else
    {
    	...
    	IfxStdIf_DPipe_print(io, "  SrvScanAngle: %6.4f fraction"ENDL, IR_getSrvScanAngle());
    }
...
void AsclinShellInterface_runRadar(void)
{
	sint32 i;
	static sint32 cnt;

	if(g_Radar.enable == TRUE)
	{
		cnt--;
		if(cnt < 0){
			cnt = (sint32) g_Radar.period_ms/10;

			for(i = 0; i <24; i++){
				IfxStdIf_DPipe_print(&g_AsclinShellInterface.stdIf.asc, "%d,%d"ENDL, i,IR_Radar[i]);
			}
		}
	}
}
