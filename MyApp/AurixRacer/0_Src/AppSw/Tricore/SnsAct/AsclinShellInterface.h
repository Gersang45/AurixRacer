...
typedef struct
{
    uint8 tx[CFG_ASC0_TX_BUFFER_SIZE + sizeof(Ifx_Fifo) + 8];
    uint8 rx[CFG_ASC0_TX_BUFFER_SIZE + sizeof(Ifx_Fifo) + 8];
} AppAscBuffer;
...
IFX_EXTERN void AsclinShellInterface_runRadar(void);
