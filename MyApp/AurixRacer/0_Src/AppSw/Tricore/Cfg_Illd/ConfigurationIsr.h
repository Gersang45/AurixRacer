...
#define ISR_PRIORITY_CCU6_ICU       250   /**< \brief Define the CCU6 ICU interrupt priority.  */
#define ISR_PRIORITY_CCU6_ICU_POS   251
#define ISR_PRIORITY_CCU6_ICU_F     252
#define ISR_PRIORITY_CCU6_ICU_ENC   253
...
#define ISR_PROVIDER_CCU6_ICU       IfxSrc_Tos_cpu0
#define ISR_PROVIDER_CCU6_ICU_F     IfxSrc_Tos_cpu0
#define ISR_PROVIDER_CCU6_ICU_POS   IfxSrc_Tos_cpu0
#define ISR_PROVIDER_CCU6_ICU_ENC   IfxSrc_Tos_cpu0
...
#define INTERRUPT_CCU6_ICU_F        ISR_ASSIGN(ISR_PRIORITY_CCU6_ICU_F, ISR_PROVIDER_CCU6_ICU_F)             /**< \brief Install the CCU6 ICU interrupt handler.  */
#define INTERRUPT_CCU6_ICU_POS      ISR_ASSIGN(ISR_PRIORITY_CCU6_ICU_POS, ISR_PROVIDER_CCU6_ICU_POS)
#define INTERRUPT_CCU6_ICU_ENC      ISR_ASSIGN(ISR_PRIORITY_CCU6_ICU_ENC, ISR_PROVIDER_CCU6_ICU_ENC)
