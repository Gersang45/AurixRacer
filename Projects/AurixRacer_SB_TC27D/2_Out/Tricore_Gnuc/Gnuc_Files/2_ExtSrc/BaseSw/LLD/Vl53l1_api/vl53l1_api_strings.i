# 1 "../../_LibSrc/iLLD_1_0_1_8_0__TC27D/Src/BaseSw/LLD/Vl53l1_api/vl53l1_api_strings.c"
# 1 "D:\\MinKyu_AurixRacer\\Projects\\AurixRacer_SB_TC27D//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../../_LibSrc/iLLD_1_0_1_8_0__TC27D/Src/BaseSw/LLD/Vl53l1_api/vl53l1_api_strings.c"
# 69 "../../_LibSrc/iLLD_1_0_1_8_0__TC27D/Src/BaseSw/LLD/Vl53l1_api/vl53l1_api_strings.c"
# 1 "../../_LibSrc/iLLD_1_0_1_8_0__TC27D/Src/BaseSw/LLD/Vl53l1_api/vl53l1_api_core.h" 1
# 72 "../../_LibSrc/iLLD_1_0_1_8_0__TC27D/Src/BaseSw/LLD/Vl53l1_api/vl53l1_api_core.h"
# 1 "../../_LibSrc/iLLD_1_0_1_8_0__TC27D/Src/BaseSw/LLD/Vl53l1_api/vl53l1_platform.h" 1
# 67 "../../_LibSrc/iLLD_1_0_1_8_0__TC27D/Src/BaseSw/LLD/Vl53l1_api/vl53l1_platform.h"
...
# 68 "../../_LibSrc/iLLD_1_0_1_8_0__TC27D/Src/BaseSw/LLD/Vl53l1_api/vl53l1_platform.h" 2
...
# 73 "../../_LibSrc/iLLD_1_0_1_8_0__TC27D/Src/BaseSw/LLD/Vl53l1_api/vl53l1_api_core.h" 2
...
# 70 "../../_LibSrc/iLLD_1_0_1_8_0__TC27D/Src/BaseSw/LLD/Vl53l1_api/vl53l1_api_strings.c" 2
# 1 "../../_LibSrc/iLLD_1_0_1_8_0__TC27D/Src/BaseSw/LLD/Vl53l1_api/vl53l1_api_strings.h" 1
# 92 "../../_LibSrc/iLLD_1_0_1_8_0__TC27D/Src/BaseSw/LLD/Vl53l1_api/vl53l1_api_strings.h"
VL53L1_Error VL53L1_get_range_status_string(
 uint8_t RangeStatus,
 char *pRangeStatusString);
# 106 "../../_LibSrc/iLLD_1_0_1_8_0__TC27D/Src/BaseSw/LLD/Vl53l1_api/vl53l1_api_strings.h"
VL53L1_Error VL53L1_get_pal_error_string(
 VL53L1_Error PalErrorCode,
 char *pPalErrorString);
# 120 "../../_LibSrc/iLLD_1_0_1_8_0__TC27D/Src/BaseSw/LLD/Vl53l1_api/vl53l1_api_strings.h"
VL53L1_Error VL53L1_get_pal_state_string(
 VL53L1_State PalStateCode,
 char *pPalStateString);
# 134 "../../_LibSrc/iLLD_1_0_1_8_0__TC27D/Src/BaseSw/LLD/Vl53l1_api/vl53l1_api_strings.h"
VL53L1_Error VL53L1_get_sequence_steps_info(
  VL53L1_SequenceStepId SequenceStepId,
  char *pSequenceStepsString);
# 147 "../../_LibSrc/iLLD_1_0_1_8_0__TC27D/Src/BaseSw/LLD/Vl53l1_api/vl53l1_api_strings.h"
VL53L1_Error VL53L1_get_limit_check_info(uint16_t LimitCheckId,
 char *pLimitCheckString);
# 71 "../../_LibSrc/iLLD_1_0_1_8_0__TC27D/Src/BaseSw/LLD/Vl53l1_api/vl53l1_api_strings.c" 2

# 1 "../../_LibSrc/iLLD_1_0_1_8_0__TC27D/Src/BaseSw/LLD/Vl53l1_api/vl53l1_error_strings.h" 1
# 90 "../../_LibSrc/iLLD_1_0_1_8_0__TC27D/Src/BaseSw/LLD/Vl53l1_api/vl53l1_error_strings.h"
VL53L1_Error VL53L1_get_pal_error_string(
 VL53L1_Error PalErrorCode,
 char *pPalErrorString);
# 73 "../../_LibSrc/iLLD_1_0_1_8_0__TC27D/Src/BaseSw/LLD/Vl53l1_api/vl53l1_api_strings.c" 2
# 83 "../../_LibSrc/iLLD_1_0_1_8_0__TC27D/Src/BaseSw/LLD/Vl53l1_api/vl53l1_api_strings.c"
VL53L1_Error VL53L1_get_range_status_string(
 uint8_t RangeStatus,
 char *pRangeStatusString)
{
 ...
 switch (RangeStatus) {
 case 0:
  (strncpy(pRangeStatusString, "Range Valid", 512 -1))
                                        ;
 break;
 case 1:
  (strncpy(pRangeStatusString, "Sigma Fail", 512 -1))
                                   ;
 break;
 case 2:
  (strncpy(pRangeStatusString, "Signal Fail", 512 -1))
                                    ;
 break;
 case 3:
  (strncpy(pRangeStatusString, "Min Range Fail", 512 -1))
                                      ;
 break;
 case 4:
  (strncpy(pRangeStatusString, "Phase Fail", 512 -1))
                                   ;
 break;
 case 5:
  (strncpy(pRangeStatusString, "Hardware Fail", 512 -1))
                                ;
 break;

 default:
  (strncpy(pRangeStatusString, "No Update", 512 -1))
                                  ;
 }
 ...
 char *pPalStateString)
{
 ...
 switch (PalStateCode) {
 case ((VL53L1_State) 0):
  (strncpy(pPalStateString, "POWERDOWN State", 512 -1))
                                 ;
 break;
 case ((VL53L1_State) 1):
  (strncpy(pPalStateString, "Wait for staticinit State", 512 -1))
                                       ;
 break;
 case ((VL53L1_State) 2):
  (strncpy(pPalStateString, "STANDBY State", 512 -1))
                               ;
 break;
 case ((VL53L1_State) 3):
  (strncpy(pPalStateString, "IDLE State", 512 -1))
                            ;
 break;
 case ((VL53L1_State) 4):
  (strncpy(pPalStateString, "RUNNING State", 512 -1))
                               ;
 break;
 case ((VL53L1_State) 5):
  (strncpy(pPalStateString, "RESET State", 512 -1))
                             ;
 break;
 case ((VL53L1_State) 98):
  (strncpy(pPalStateString, "UNKNOWN State", 512 -1))
                               ;
 break;
 case ((VL53L1_State) 99):
  (strncpy(pPalStateString, "ERROR State", 512 -1))
                             ;
 break;
  ...
  char *pSequenceStepsString)
{
 ...
 case ((VL53L1_SequenceStepId) 0):
  (strncpy(pSequenceStepsString, "VHV", 512 -1))
                                   ;
 break;
 case ((VL53L1_SequenceStepId) 1):
  (strncpy(pSequenceStepsString, "PHASE CAL", 512 -1))
                                        ;
 break;
 case ((VL53L1_SequenceStepId) 2):
  (strncpy(pSequenceStepsString, "DSS1", 512 -1))
                                    ;
 break;
 case ((VL53L1_SequenceStepId) 3):
  (strncpy(pSequenceStepsString, "DSS1", 512 -1))
                                    ;
 break;
 case ((VL53L1_SequenceStepId) 4):
  (strncpy(pSequenceStepsString, "DSS2", 512 -1))
                                    ;
 break;
 case ((VL53L1_SequenceStepId) 5):
  (strncpy(pSequenceStepsString, "MM1", 512 -1))
                                   ;
 break;
 case ((VL53L1_SequenceStepId) 6):
  (strncpy(pSequenceStepsString, "MM2", 512 -1))
                                   ;
 break;
 case ((VL53L1_SequenceStepId) 7):
  (strncpy(pSequenceStepsString, "RANGE", 512 -1))
                                     ;
 break;
 default:
 ...
 char *pLimitCheckString)
{
 ...
 switch (LimitCheckId) {
 case 0:
  (strncpy(pLimitCheckString, "SIGMA FINAL RANGE", 512 -1))
                                               ;
 break;
 case 1:
  (strncpy(pLimitCheckString, "SIGNAL RATE FINAL RANGE", 512 -1))
                                                     ;
 break;
 default:
  (strncpy(pLimitCheckString, "Unknown Error Code", 512 -1))
                                   ;
 }
