# 1 "../../MyApp/AurixRacer/0_Src/AppSw/Tricore/Algorithm/HandCode/Q_Linescan.c"
...
# 9 "../../MyApp/AurixRacer/0_Src/AppSw/Tricore/Algorithm/HandCode/InfineonRacer.h"
...
# 10 "../../MyApp/AurixRacer/0_Src/AppSw/Tricore/Algorithm/HandCode/InfineonRacer.h" 2
...
# 42 "../../_LibSrc/iLLD_1_0_1_8_0__TC27D/Src/BaseSw/iLLD/TC27D/Tricore/I2c/Std/IfxI2c.h" 2
...
# 1 "../../MyApp/AurixRacer/0_Src/AppSw/Tricore/Algorithm/HandCode/InfineonRacer.h" 1
# 9 "../../MyApp/AurixRacer/0_Src/AppSw/Tricore/Algorithm/HandCode/Q_Control.h" 2
...
# 2 "../../MyApp/AurixRacer/0_Src/AppSw/Tricore/Algorithm/HandCode/Q_Linescan.c" 2




uint16 Line_Left = 27;
uint16 Line_Right = 105;

uint16 Pre_Line_Left = 27;
uint16 Pre_Line_Right = 105;
...
uint16 InfineonRacer_FindBlack(uint16 start, uint16 final, uint16 lr)
{
 ...
 {
  line_k = 14;
  for(k = start; k >= final+2 +1; k--)
  {
   var = IR_LineScan.adcResult[0][k]*0.75;
   if(IR_LineScan.adcResult[0][k-2] < var
      || IR_LineScan.adcResult[0][k-2 -1] < var)
   {
    line_k = k;
    break;
   }
...
void InfineonRacer_detectLane(void)
{
 ...
 if(State_Track == Normal || State_Track == Dashline || State_Track == AEB)
 {
  switch(State_Scan)
  {
   ...
   case 21:
   case 22:
    Line_Left = InfineonRacer_FindBlack(Offset, 14, 0);
    Line_Right = InfineonRacer_FindBlack(Offset, 119, 1);
    ...
    if(Line_Left == 14)
    {
     ...
     else if(Line_Right > 66)
     {
      Offset = 66 + Line_Right - 105;
      State_Scan = 12;
     }
     else
     {
    ...
    else if(Line_Left < 66)
    {
     if(Line_Right == 119)
     {
      Offset = 66 + Line_Left - 27;
      State_Scan = 21;
     }
     else
     {
...
void InfineonRacer_DetectCrosswalk(void)
{
 ...
 for(i = Pre_Line_Left; i <= Pre_Line_Right - 2; i++)
 {
  var = IR_LineScan.adcResult[0][i]*0.75;
  if(IR_LineScan.adcResult[0][i+2] < var) cnt_black++;
 }
