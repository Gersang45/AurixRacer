# 1 "../../MyApp/AurixRacer/0_Src/AppSw/Tricore/Algorithm/HandCode/Q_CollisionAvoidance.c"
...
# 8 "../../MyApp/AurixRacer/0_Src/AppSw/Tricore/Algorithm/HandCode/Q_CollisionAvoidance.h" 2
...
# 2 "../../MyApp/AurixRacer/0_Src/AppSw/Tricore/Algorithm/HandCode/Q_CollisionAvoidance.c" 2
 ...
 for(i=0; i <24; i++)
 {
  if(IR_Radar[i] <= 1000)
  {
   if( i == 1 || i == 2 || i == 3){
    ...
    RefCnt = (uint16)(TargetPoint_Dsitacne/(Speed*20));
