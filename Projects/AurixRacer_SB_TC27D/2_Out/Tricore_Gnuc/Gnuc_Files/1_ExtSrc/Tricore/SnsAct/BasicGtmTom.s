...
.LVL0:
	...
	addi	%d15, %d15, -16491
	.loc 1 151 0
	movh.a	%a2, hi:IfxGtm_TOM0_0_TOUT77_P15_6_OUT
	lea	%a15, [%a2] lo:IfxGtm_TOM0_0_TOUT77_P15_6_OUT
	.loc 1 147 0
	st.w	[%SP] 68, %d15
	.loc 1 151 0
	ld.bu	%d15, [%a2] lo:IfxGtm_TOM0_0_TOUT77_P15_6_OUT
	st.b	[%SP] 100, %d15
	.loc 1 152 0
	ld.bu	%d15, [%a15] 1
	.loc 1 154 0
	...
	mov	%d2, 500
	.loc 1 162 0
	movh.a	%a15, hi:g_GtmTomPwmHl+16
	lea	%a15, [%a15] lo:g_GtmTomPwmHl+16
	lea	%a5, [%SP] 60
	mov.aa	%a4, %a15
	.loc 1 154 0
	st.b	[%SP] 108, %d8
...
.LVL2:
	.loc 1 188 0
	movh	%d2, hi:IfxGtm_TOM0_3_TOUT105_P10_3_OUT
	addi	%d2, %d2, lo:IfxGtm_TOM0_3_TOUT105_P10_3_OUT
	.loc 1 205 0
	lea	%a2, [%SP] 4
	st.a	[%SP] 52, %a2
	.loc 1 188 0
	st.w	[%SP] 4, %d2
	.loc 1 189 0
	movh	%d2, hi:IfxGtm_TOM0_4_TOUT22_P33_0_OUT
	addi	%d2, %d2, lo:IfxGtm_TOM0_4_TOUT22_P33_0_OUT
	.loc 1 206 0
	lea	%a2, [%SP] 16
	.loc 1 209 0
	lea	%a4, [%a15] 60
	...
	st.w	[%SP] 16, %d2
	.loc 1 190 0
	movh	%d2, hi:IfxGtm_TOM0_2_TOUT107_P10_5_OUT
	addi	%d2, %d2, lo:IfxGtm_TOM0_2_TOUT107_P10_5_OUT
	.loc 1 209 0
	lea	%a5, [%SP] 28
	.loc 1 195 0
	st.a	[%SP] 44, %a15
	...
	st.w	[%SP] 8, %d2
	.loc 1 191 0
	movh	%d2, hi:IfxGtm_TOM0_5_TOUT23_P33_1_OUT
	addi	%d2, %d2, lo:IfxGtm_TOM0_5_TOUT23_P33_1_OUT
	.loc 1 200 0
	st.b	[%SP] 37, %d8
	.loc 1 202 0
	st.b	[%SP] 39, %d8
	...
	st.w	[%SP] 20, %d2
	.loc 1 192 0
	movh	%d2, hi:IfxGtm_TOM0_1_TOUT103_P10_1_OUT
	addi	%d2, %d2, lo:IfxGtm_TOM0_1_TOUT103_P10_1_OUT
	.loc 1 203 0
	st.b	[%SP] 40, %d15
	.loc 1 204 0
	st.b	[%SP] 41, %d15
	...
	st.w	[%SP] 12, %d2
	.loc 1 193 0
	movh	%d2, hi:IfxGtm_TOM0_6_TOUT24_P33_2_OUT
	addi	%d2, %d2, lo:IfxGtm_TOM0_6_TOUT24_P33_2_OUT
	.loc 1 206 0
	st.a	[%SP] 56, %a2
	.loc 1 193 0
	st.w	[%SP] 24, %d2
...
.LVL5:
	...
	addi	%d15, %d15, -14932
	.loc 1 226 0
	movh.a	%a2, hi:IfxGtm_TOM0_12_TOUT98_P11_9_OUT
	lea	%a15, [%a2] lo:IfxGtm_TOM0_12_TOUT98_P11_9_OUT
	.loc 1 224 0
	st.w	[%SP] 12, %d15
	.loc 1 226 0
	ld.bu	%d15, [%a2] lo:IfxGtm_TOM0_12_TOUT98_P11_9_OUT
	st.b	[%SP] 44, %d15
	.loc 1 227 0
	ld.bu	%d15, [%a15] 1
	st.b	[%SP] 45, %d15
...
.LVL8:
	...
	addi	%d15, %d15, -14932
	.loc 1 285 0
	movh.a	%a2, hi:IfxGtm_TOM0_13_TOUT99_P11_10_OUT
	lea	%a15, [%a2] lo:IfxGtm_TOM0_13_TOUT99_P11_10_OUT
	.loc 1 283 0
	st.w	[%SP] 12, %d15
	.loc 1 285 0
	ld.bu	%d15, [%a2] lo:IfxGtm_TOM0_13_TOUT99_P11_10_OUT
	st.b	[%SP] 44, %d15
	.loc 1 286 0
	ld.bu	%d15, [%a15] 1
	st.b	[%SP] 45, %d15
...
.LVL19:
	st.w	[%a12] 8, %d2
	.loc 1 341 0
	movh.a	%a12, hi:g_GtmTomPwmHl+16
	lea	%a12, [%a12] lo:g_GtmTomPwmHl+16
	.loc 1 340 0
...
.LASF128:
	...
	.extern	IfxGtm_TOM0_5_TOUT23_P33_1_OUT,STT_OBJECT,20
	.extern	IfxGtm_TOM0_2_TOUT107_P10_5_OUT,STT_OBJECT,20
	.extern	IfxGtm_TOM0_4_TOUT22_P33_0_OUT,STT_OBJECT,20
	.extern	IfxGtm_TOM0_3_TOUT105_P10_3_OUT,STT_OBJECT,20
	.extern	IfxGtm_Tom_PwmHl_initConfig,STT_FUNC,0
	.extern	IfxGtm_Tom_Timer_init,STT_FUNC,0
	.extern	IfxGtm_TOM0_0_TOUT77_P15_6_OUT,STT_OBJECT,20
